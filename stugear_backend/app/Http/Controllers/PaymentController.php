...
class PaymentController extends Controller
{
    ...
    public function momoPayment(Request $request)
    {
        ...
        $orderId = time() . "";
        $redirectUrl = "https://stugear-qa.website/payment-success";
        $ipnUrl = "https://stugear-qa.website/payment-success";
        $extraData = "";
    ...
    public function vnpayPayment(Request $request)
    {
        ...
        $vnp_Returnurl = "https://stugear-qa.website/payment-success";
